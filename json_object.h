 ...
 */
JSON_EXPORT void json_object_object_add_ex(struct json_object* obj, const char *key,
 ...
 */
THIS_FUNCTION_IS_DEPRECATED(JSON_EXPORT struct json_object* json_object_object_get(const struct json_object* obj,
						  const char *key));
 ...
 * @param val the json_object to be added
 */
JSON_EXPORT int json_object_array_put_idx(struct json_object *obj, int idx,
				     struct json_object *val);
